...
class AES:
    ...
    def _encrypt_block(self, ar=True):
        if ar:
    ...
    def encrypt(self, plaintext, ar=True):
        ciphertext = b''

        self._state = self._transpose([c for c in plaintext])
        self._encrypt_block(ar)
...
#    t1 = cip.ecnrypt(b'\x00' * 16)
    ...
    print(t2)
    l = []
    print(f"p1, p2, c1, c2 = {p1}, {p2}, {c1}, {c2}")

    c3 = cip.encrypt(t1, False)
    print(c3)
